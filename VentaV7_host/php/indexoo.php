...
<body>
        ...
        <div class="menuu">
            <div class="cont_menuu">
                ...
                <div class="iniciar_sesion" id="iniciar_sesion">
                    ...
                    <p>Iniciar Sesion</p>
                    <?php
                    }elseif($_SESSION["a"]==1 or $_SESSION["a"]==2){
                        ?>
                    <p><?php echo "$nane"; ?></p>
                    <?php
                    }
    ...
    ?>
        ...
        ?>
            <div class="contain_login" id="contain_login">
                ...
                <form  action="iniciouser.php"method="post" class="formlogin" id="formlogin">
            ...
            <div class="contain_registro" id="contain_registro">
                <form  method="post"class="formregistro" id="formregistro">
                    ...
                    <button type="button" id="closeregister">Cancelar</button>
                </form>
            </div>
        <?php 
            }if($pt==1 or $pt==2){
        ...
        <div class="contain_cerrar" id="contain_cerrar">
                <form action="change.php"method="post" class="formclose" id="formclose">
                    <input type="hidden" name="pase" value="2">
                    <input type="hidden" name="id" value="<?php echo $a?>">
                        <button type="submit" id="closesesion">Cerrar sesion</button>
                    </div>  
                </form>
        </div>
        <?php
    ...
    <form class="close_description">
            <button type="submit" id="close_des">Cerrar</button>
    </form>
