...
$id=$_POST["idrol"];
$buscador=$_POST["bus"];
$a=mysqli_query($c,"SELECT * FROM inventario WHERE nombre='$buscador'");
if ($a){
    if (mysqli_num_rows($a) > 0) {
        while ($fila = $a->fetch_assoc()) {
                                    ...
                                    <div class="productos">
                                        ...
                                        <div class="cont_forms">
                                            ...
                                            <form method="post" class="description" data-form="<?php echo $fila["id_pr"];?>">
                                                    ...
                                                    <input type="hidden" name="iduser" value="<?php echo $id_user;?>">
                                                    <input type="hidden" name="idpr" value="<?php echo $fila['id_pr'];?>">
                                                    <button type="submit" class="opendes" >
                                                        Descripcion
                                                    </button>
                                                </form>
                                        </div>
            ...
            <?php
if($buscador==""){
    $jut = mysqli_query($c,"SELECT * FROM inventario");
    if (mysqli_num_rows($jut)>0) {
        while($fila= $jut->fetch_assoc()) {
        ?>
                           <div class="pr">
                        <div class="productos">
                            <div class="imgg">
