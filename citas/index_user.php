...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="./css/index_user0.css">
...
<body id="body">
    <main>
        <header>
            ...
            <div class="barra">
                ...
                <form action="usuario.php" method="post" id="form_kevin">
                    <input type="hidden" name="dato" id="dato" value="<?php echo $dato?>">
                    <button type="submit" class="boton_kevin">Agendar cita</button>
                </form>
                <form action="../VentaV7_host/php/validar_start.php" method="post" id="form_kevin">
                    <input type="hidden" name="correo" value="<?php echo $a1?>">
                    <input type="hidden" name="pass" value="<?php echo $b1?>">
                    <button type="submit" class="boton_kevin">Farmacia</button>
                </form>
                <a href="#somos" id="blanco">Quienes Somos</a>
                <a href="#" class="font-blanco" id="sesion">
                    <?php
                        if($_SESSION['user'] != null){
                            echo $_SESSION['user'];
                        }else{
    ...
    <section class="sect3">
        ...
        <div class="caja_co">
            <form action="./sugerencia.php" method="POST" class="form_suge">
    ...
    <div class="modal">
        <div class="container">
            <form action="index.php" class="form_sesion" method="post">
                <div class="se_text">
                ...
                <p>Si olvido su contraseña da click <a href="#">Recuperar</a></p>
                ...
                <!-- sesion.html -->
                <!-- ... -->
                <button type="submit" id="btnIniciarSesion" class="boto"><a href="registro.html">Registrar</a></button>
                <!-- ... -->
...
?>
<script>
        const init= document.querySelector('#sesion');
        const closesesion= document.querySelector('#cerrarsesion');
        const closee = document.querySelector('#cancell');

        // Función para mostrar la sección de Agendar citas
        function abrir1() {
            closesesion.style.display = 'flex';
        ...
        // Agregar eventos a los enlaces
        init.addEventListener('click', abrir1);
        closee.addEventListener('click', cerrar1);
</script>
